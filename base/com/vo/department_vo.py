...
class DepartmentVO(db.Model):
    ...
    department_name = db.Column('department_name', db.String(255), nullable=False)
    department_description = db.Column('department_description', db.String(255), nullable=False)
