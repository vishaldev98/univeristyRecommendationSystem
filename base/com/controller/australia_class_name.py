...
def write_data():
    ...
    txt_file = open(r"C:\projectworkspace\universityrecommendation\base\static\adminResources/australia_classes.txt", "w")
...
def read_data(college_id):
    txt_file = open(r"C:\projectworkspace\universityrecommendation\base\static\adminResources/australia_classes.txt", "r")
    data_dict = {}
