...
def admin_load_department():
    try:
        ...
        print("admin_load_department route exception occurred >>>>>>>>>>", ex)
...
def admin_insert_department():
    try:
        ...
        print("admin_insert_department route exception occurred >>>>>>>>>>", ex)
...
def admin_view_department():
    try:
        ...
        print("admin_view_department route exception occurred >>>>>>>>>>", ex)
...
def admin_delete_department():
    try:
        ...
        print("admin_delete_department route exception occurred >>>>>>>>>>", ex)
...
def admin_edit_department():
    try:
        ...
        degree_vo_list = degree_dao.view_degree()
        return render_template('admin/editDepartment.html', degree_vo_list=degree_vo_list, department_vo_list=department_vo_list)
    except Exception as ex:
        print("admin_edit_department route exception occurred >>>>>>>>>>", ex)
...
def admin_update_department():
    try:
        ...
        print("admin_update_department route exception occurred >>>>>>>>>>", ex)
