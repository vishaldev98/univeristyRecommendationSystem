...
def write_data():
    acedamic_dataframe = pd.read_excel(
        r'C:\projectworkspace\universityrecommendation\base\static\adminResources\dataset\Dataset_USA.xlsx')
    txt_file = open(r"C:\projectworkspace\universityrecommendation\base\static\adminResources/usa_classes.txt", "w")
...
def read_data(college_id):
    txt_file = open(r"C:\projectworkspace\universityrecommendation\base\static\adminResources/usa_classes.txt", "r")
    data_dict = {}
